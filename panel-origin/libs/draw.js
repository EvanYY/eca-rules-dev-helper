...
function draw() {
  ...
  var myChart = echarts.init(document.getElementById("sangji"));
  ...
  myChart.on("click", (e) => {
    console.log("🚀 ~ file: draw.js ~ line 200 ~ myChart.on ~ e", e);
    // if (e.data.source) return;
    let { dataIndex, event } = e;
    console.log("🚀 ~ file: draw.js ~ line 201 ~ myChart.on ~ name", dataIndex);
    ...
    //   y: event.offsetY,
    // });
    // console.log("🚀 ~ file: draw.js ~ line 207 ~ myChart.on ~ myChart", myChart)
  });
  // 使用刚指定的配置项和数据显示图表。
